...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.css">
 ...
 <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Plotting Tim / TPS. /</span> Data Plotting Tim</h4> <!-- title -->
    ...
    <div class="card">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-2">
            <br>
            <a href="/plotting_tps/tim"><button type="button" class="btn btn-primary"><i class="tf-icons ti ti-arrow-back"></i> Refresh</button></a>
          </div>
        </div>
      </div>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <form action="/plotting_tps/tim/{{ $item->id }}" method="post">
                      @method('delete')
                      @csrf
        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
          <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
              ...
              <form action="/plotting_tps/tim" method="post" class="row g-3">
                @csrf
                <div class="col-12">
                    <label class="form-label" for="multicol-country">Anggota Tim</label>
                ...
                <div class="col-12">
                    <label class="form-label" for="multicol-country">TPS</label>
                    <select id="tps_form" name="tps" class="form-select" required>
                        <option value="">Pilih</option>
                    </select>
                </div>
...
<script>
    ...
    $("#kelurahan" ).change(function() {
      location.replace('/plotting_tps/tim?kelurahan=' + kelurahan.value + '&tps=' + tps.value + '&anggota_tim=' + anggota_tim_cari.value)
    });
...
// Department Change
    $('#kelurahan_form').change(function(){
        ...
        // Empty the dropdown
        $('#tps_form').find('option').not(':first').remove();
            ...
            success: function(response){
                ...
                if(len > 0){
                    ...
                    for(var i=0; i<len; i++){
                        ...
                        var total_pemilih_tps = response['data'][i].total_pemilih_tps;

                        var option = "<option value='"+nama+"'>TPS "+nama+". total pemilih "+total_pemilih_tps+"</option>";

                        $("#tps_form").append(option); 
                    }
                }
