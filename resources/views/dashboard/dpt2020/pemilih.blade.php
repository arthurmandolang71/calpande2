...
@section('content')
 ...
 <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
      <h5 class="card-header">Data Pemilih Tetap 2020 | total : {{ $total_get }} Pemilih </h5><!-- title -->
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2">
          <br>
          <a href="/pemilih/dpt2020"><button type="button" class="btn btn-primary"><i class="tf-icons ti ti-arrow-back"></i></button></a>
                ...
                <td> 
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="/pemilih/dpt2020/{{ $item->id }}"
  ...
  <script>
    ...
    $("#kelurahan" ).change(function() {
      location.replace('/pemilih/dpt2020?kelurahan=' + kelurahan.value + '&tps=' + tps.value + '&lingkungan=' + lingkungan.value + '&nama=' + nama.value)
    });
